...
We find that the scores have a linear trend when plotted against each other. This means that the students who score well in one section generally tend to perform well in the other as well. We try to fit a 'linear model' line and see that most of the data points like relatively near the line with very few extreme outliers.
